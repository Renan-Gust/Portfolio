            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <article className="bg-dark-gray border-solid border border-gray">
                    <div className="p-8 border-b-4 border-green h-full">
                        ...
                        <p className="text-secondary-gray">Desenvolvimento de sistemas 100% personalizados que vão automatizar a administração do seu negócio.</p>
                    </div>
                </article>
                ...
                <article className="bg-dark-gray border-solid border border-gray">
                    <div className="p-8 border-b-4 border-green h-full">
                        ...
                        <p className="text-secondary-gray">Sites que adaptam o tamanho das suas páginas ao tamanho das telas que estão sendo exibidos, facilitando a sua visualização.</p>
                    </div>
                </article>
                ...
                <article className="bg-dark-gray border-solid border border-gray">
                    <div className="p-8 border-b-4 border-green h-full">
                        ...
                        <p className="text-secondary-gray">Forma de deixar o site com suas informações bem compreensíveis para o computador, ajudando sua busca no Google e facilitando o entendimento de leitores de acessibilidade.</p>
                    </div>
                </article>
            </div>
        </section>
